...
def edit_command_created(args: adsk.core.CommandCreatedEventArgs):
    ...
    # chainLinks = inputs.addIntegerSpinnerCommandInput( "chain_links", "Belt Teeth", 35, 400, 2, 60 )
...
def edit_command_input_changed(args: adsk.core.InputChangedEventArgs):
    ...
    #             chainLinks.value = 60
    #         if motionType.selectedItem.index < 4:
...
#     select_sep.isEnabled = False
#     cog1Teeth.isEnabled = False
#     cog1Group.isEnabled = False
#     cog1Group.isEnabledCheckBoxDisplayed = False
#     cog2Teeth.isEnabled = False
#     cog2Group.isEnabled = False
#     cog2Group.isEnabledCheckBoxDisplayed = False
#     beltTeeth.isEnabled = False
#     extraCenter.isEnabled = False
#     swap_cogs.isEnabled = False
...
def edit_command_execute(args: adsk.core.CommandEventArgs):
    ...
    # if CCDialog.curveSelection.selectionCount > 0:
    #     # Editing an existing CCLine
    #     ccLine = CCLine.getCCLineFromEntity( CCDialog.curveSelection.selection(0).entity )
    ...
    # if not ccutil.isCCLine( SelectedLine.line ):
    #     # ccutil.calcCCLineData( ccLine.data )
    #     # if ccLine.data.ccDistIN < 0.001:
    #     #     return
    #     ccutil.dimAndLabelCCLine( SelectedLine )
    #     ccutil.createEndCircles( SelectedLine )
    # else:
    #     # ccutil.calcCCLineData( ccLine.data )
    #     # if ccLine.data.ccDistIN < 0.001:
    #     #     return
